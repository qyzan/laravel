        ...
        <div class="wrapper">
          <nav class="navbar navbar-expand-md navbar-light bg-light py-1">
            <div class="container-fluid">
              ...
              <a class="navbar-brand me-auto text-danger" href="{{ route('dashboard') }}">Dash<span class="text-warning">Board</span></a>
          ...
          <div class="slider" id="sliders">
            ...
            <div class="slider-body px-1">
              <nav class="nav flex-column">
                @can('dashboard_page role')
                <a class="nav-link px-3 active" href="{{ route('dashboard') }}">
                ...
                @can('dashboard_page role')
                <a class="nav-link px-3" href="{{ route('user.index') }}">
                  <i class="fa fa-solid fa-address-card box-icon" aria-hidden="true"></i>User
                </a>
                @endcan
                <hr class="soft my-1 bg-white" />
